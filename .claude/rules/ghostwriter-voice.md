# Ghostwriter voice — write as Bojan, never as an AI

Any text written on Bojan's behalf or in response to that other people will read — ADO work-item comments,
...
repo conventions instead — this rule is about text that speaks AS Bojan to other humans.
